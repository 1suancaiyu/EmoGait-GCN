...
class Emo_GCN_Model(nn.Module):
    ...
    def __init__(self, in_channels, num_classes, num_point=21, num_set=1, temporal_kernel_size=5):
        ...
        self.Emo_GCN_networks = nn.ModuleList((
            TCN_GCN_unit(in_channels, out_channels=64, A=adaptive_A, stride=1, temporal_receptive_field=temporal_kernel_size, residual=True, adaptive=True),
            ...
            TCN_GCN_unit(in_channels=64, out_channels=64, A=adaptive_A, stride=1, temporal_receptive_field=temporal_kernel_size, residual=True, adaptive=True),
            TCN_GCN_unit(in_channels=64, out_channels=64, A=adaptive_A, stride=1, temporal_receptive_field=temporal_kernel_size, residual=True, adaptive=True),
            TCN_GCN_unit(in_channels=64, out_channels=128, A=adaptive_A, stride=2, temporal_receptive_field=temporal_kernel_size, residual=True, adaptive=True),
            TCN_GCN_unit(in_channels=128, out_channels=128, A=adaptive_A, stride=1, temporal_receptive_field=temporal_kernel_size, residual=True, adaptive=True),
            TCN_GCN_unit(in_channels=128, out_channels=128, A=adaptive_A, stride=1, temporal_receptive_field=temporal_kernel_size, residual=True, adaptive=True),
            TCN_GCN_unit(in_channels=128, out_channels=256, A=adaptive_A, stride=2, temporal_receptive_field=temporal_kernel_size, residual=True, adaptive=True),
            TCN_GCN_unit(in_channels=256, out_channels=256, A=adaptive_A, stride=1, temporal_receptive_field=temporal_kernel_size, residual=True, adaptive=True),
            TCN_GCN_unit(in_channels=256, out_channels=256, A=adaptive_A, stride=1, temporal_receptive_field=temporal_kernel_size, residual=True, adaptive=True),
        ))

        # fcn for prediction
        self.conv_fcn = nn.Conv2d(128, num_classes, kernel_size=1)
        self.linear_fcn = nn.Linear(128, num_classes)
